...
Exhibit.OrderedViewFrame.l10n.sortingControlsTemplate="sorted by <span class='drop-down'><span id='ordersSpan'></span></span> <span class='drop-down'><a id='thenSortByAction' href='javascript:void' class='exhibit-action' title='Further sort the items'>then by</a></span>";
...
Exhibit.CollectionSummaryWidget.l10n.filteredResultsTemplate="<span class='%0' id='resultDescription'></span> filtered from <span id='originalCountSpan'>0</span> originally <span class='close-btn'><span id='resetActionLink'></span></span>";
