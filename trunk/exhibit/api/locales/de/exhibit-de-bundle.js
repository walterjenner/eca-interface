...
Exhibit.Database.l10n.sortLabels={"text":{ascending:"a - z",descending:"z - a"},"number":{ascending:"kleinstes zuerst",descending:unescape("gr%F6%DFtes zuerst")},"date":{ascending:"fr&uuml;hestes zuerst",descending:"sp&auml;testes zuerst"},"boolean":{ascending:"falsch zuerst",descending:"wahr zuerst"},"item":{ascending:"a - z",descending:"z - a"}};
...
Exhibit.l10n.exportDialogBoxPrompt="Kopieren Sie diesen Code wie normalen Text in die Zwischenablage. Dr&uuml;cken Sie ESC um dieses Dialogfenster zu schlie&szlig;en.";
...
}Exhibit.ViewPanel.l10n.createSelectViewActionTitle=function(A){return"W&auml;hle Sicht "+A;
};
...
}Exhibit.CollectionSummaryWidget.l10n.resetFiltersLabel="Alle Filter zur&uuml;cksetzen";
Exhibit.CollectionSummaryWidget.l10n.resetFiltersTooltip="Alle Filter zur&uuml;cksetzen und urspr&uuml;ngliche Elemente anzeigen";
Exhibit.CollectionSummaryWidget.l10n.resetActionTitle="Alle Filter zur&uuml;cksetzen";
...
Exhibit.CollectionSummaryWidget.l10n.filteredResultsTemplate="<span class='%0' id='resultDescription'></span> gefiltert von urspr&uuml;nglich <span id='originalCountSpan'>0</span> (<span id='resetActionLink'></span>)";
...
Exhibit.FacetUtilities.l10n.facetSelectOnlyActionTitle="W&auml;hle nur %0 in Facette %1 aus";
Exhibit.FacetUtilities.l10n.facetClearSelectionsActionTitle="L&ouml;sche Auswahl in Facette %0";
Exhibit.FacetUtilities.l10n.facetTextSearchActionTitle="Textsuche %0";
Exhibit.FacetUtilities.l10n.facetClearTextSearchActionTitle="Textsuche zur&uuml;cksetzen";
...
return String.substitute("<a class='exhibit-action exhibit-views-unplottableCount' href='javascript:void' id='unplottableCountLink'>%0</a> von <class class='exhibit-views-totalCount'>%1</span> k&ouml;nnen nicht angezeigt werden.",[D==1?(D+" Ergebnis"):(D+" Ergebnisse"),B]);
};
