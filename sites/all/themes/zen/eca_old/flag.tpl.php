...
?>
<div class="flag-wrapper-outer">
<div class="flag-wrapper flag-<?php echo $flag_name_css; ?>">
  <a href="<?php echo $link_href; ?>" title="<?php echo $link_title; ?>" class="<?php print $flag_classes ?> tooltip"><span>&nbsp;</span><div class="flag-throbber">&nbsp;</div></a>
